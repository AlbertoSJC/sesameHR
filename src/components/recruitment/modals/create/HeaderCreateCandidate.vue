...
const buttonFormClasses = computed(() => {
  if (recruitmentStore.formStatus === ModalFormSuccess.Success) return 'bg-[#137019] border-[#137019] text-white pointer-none font-bold';
  if (recruitmentStore.formStatus === ModalFormSuccess.Failure) return 'bg-[#801111] border-[#801111] text-white pointer-none font-bold';
  return '';
});
